					...
					<li className="py-3 sm:py-4">
						<div className="items-center space-x-4">
							...
							<div className="mt-4 flex space-x-3 lg:mt-6">
								<Button size="xs" onClick={() => edit({ action: "Edit", tweet, index, id })}>Edit</Button>
								<Button size="xs" onClick={() => remove({ action: "Delete", tweet, index, id })} color="failure">Delete</Button>
							</div>
						</div>
					</li>
				</ul>
